        ...
        <div className='flex flex-wrap justify-center px-2'>
            {
                genres.map((genre) => (
                    ...
                    <button
                        ...
                        className={activegenre === genre.name ? 'active px-4 py-2 m-2 text-[15px] text-white font-semibold rounded-3xl' : 'px-4 py-2 m-2 text-[15px] bg-slate-800 text-white font-semibold rounded-3xl'} key={genre.name}>
                        {genre.name}
                    </button>
