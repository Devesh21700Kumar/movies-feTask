...
export function MovieProvider({ children }) {
 ...
 const filteredGenre = async () => {
    ...
    const data = await fetch(
      `${URL}/searchByGenre?page=${page}&searchByGenre=${activegenre}`
    );
    ...
    setTotalPage(filteredGenre.totalPage);
    setLoader(false);
    setHeader("Genres");
  };
